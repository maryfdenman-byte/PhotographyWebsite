...
const faqs = [
  ...
  },
  {
    ...
    a: 'Yes! I offer on-location sessions for corporate teams and offices throughout the Greenville, SC area. The fee is $600 for up to three hours onsite, plus $125 per image.',
  },
  {
