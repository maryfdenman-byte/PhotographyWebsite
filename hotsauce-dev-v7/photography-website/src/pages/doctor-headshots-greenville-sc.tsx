...
export default function DoctorHeadshotsPage() {
  return (
    <Layout
      ...
      description="Headshots for physicians, dentists and healthcare practices in Greenville and Taylors, SC. Studio sessions at Taylors Mill or on location at your practice. $125 session + $125 per image."
    >
      <ServicePage
        ...
        sections={[
          ...
          },
          {
            ...
            paragraphs: [
              'The session fee is $125 and covers the shoot. Images are $125 each, so you take exactly the number you need — most clients choose two to five, which is usually enough for a practice bio, a directory listing, and LinkedIn.',
